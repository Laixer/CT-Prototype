...
<div id="page-bgtop">
	<div id="title">
		...
		<span>Eindresultaat Calculatie</span>
		...
		<div id="intern">
			<div id="table">
				<table width="100%" border="0">
					<tr class="tbl-head">
						<td>Aanneming</td>
						<td align="center"><div align="center">Manuren</div></td>
						<td><div align="center"></div></td>
						<td align="left"><div align="center">Bedrag (excl. BTW)</div></td>
						<td><div align="center"></div></td>
					...
					<tr>
						<td><?php if(!$head_sal_1){ echo "Arbeidskosten"; $head_sal_1=1; } ?></td>
					...
					<tr>
						<td width="387"><?php if(!$head_sal_1){ echo "Arbeidskosten"; $head_sal_1=1; } ?></td>
					...
					<tr>
						<td><?php if(!$head_sal_2){ echo "Arbeidskosten"; $head_sal_2=1; } ?></td>
					...
					<tr>
						<td><?php if(!$head_sal_3){ echo "Arbeidskosten"; $head_sal_3=1; } ?></td>
					...
					<?php if($rs_project_result_row['Sum_3_notax_40']){ ?>
					<tr>
						<td><?php if(!$head_sum_3){ echo "Totaalposten"; $head_sum_3=1; } ?></td>
						<td width="89">&nbsp;</td>
						<td width="20">&nbsp;</td>
						<td width="127" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_3_notax_40'], 2, ',', '.'); ?></td>
						<td width="81">&nbsp;</td>
						<td width="117" align="center">21%</td>
						<td width="20">&nbsp;</td>
						<td width="126" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_3_tax_40'], 2, ',', '.'); ?></td>
						<td width="89">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Sum_3_notax_20']){ ?>
					<tr>
						<td><?php if(!$head_sum_3){ echo "Totaalposten"; $head_sum_3=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_3_notax_20'], 2, ',', '.'); ?></td>
						<td align="right">&nbsp;</td>
						<td align="center">6%</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_3_tax_20'], 2, ',', '.'); ?></td>
						<td align="right">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Sum_3_notax_10']){ ?>
					<tr>
						<td><?php if(!$head_sum_3){ echo "Totaalposten"; $head_sum_3=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td width="127" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_3_notax_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">0%</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php if($rs_project_result_row['Salary_amount_4_40']){ ?>
					<tr>
						<td><?php if(!$head_sal_4){ echo "Arbeidskosten"; $head_sal_4=1; } ?></td>
						<td width="89" align="center"><?php echo number_format($rs_project_result_row['Salary_amount_4_40'], 2, ',', '.'); ?></td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="127" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Salary_4_notax_40'], 2, ',', '.'); ?></td>
						<td width="81">&nbsp;</td>
						<td width="117" align="center">21%</td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="126" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Salary_4_tax_40'], 2, ',', '.'); ?></td>
						<td width="89">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Salary_amount_4_20']){ ?>
					<tr>
						<td><?php if(!$head_sal_4){ echo "Arbeidskosten"; $head_sal_4=1; } ?></td>
						<td align="center"><?php echo number_format($rs_project_result_row['Salary_amount_4_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Salary_4_notax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">6%</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Salary_4_tax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Salary_amount_4_10']){ ?>
					<tr>
						<td><?php if(!$head_sal_4){ echo "Arbeidskosten"; $head_sal_4=1; } ?></td>
						<td align="center"><?php echo number_format($rs_project_result_row['Salary_amount_4_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Salary_4_notax_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">0%</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php if($rs_project_result_row['Material_4_notax_40']){ ?>
					<tr>
						<td><?php if(!$head_mat_4){ echo "Materiaalkosten"; $head_mat_4=1; } ?></td>
						<td width="89">&nbsp;</td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="127" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Material_4_notax_40'], 2, ',', '.'); ?></td>
						<td width="81">&nbsp;</td>
						<td width="117" align="center">21%</td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="126" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Material_4_tax_40'], 2, ',', '.'); ?></td>
						<td width="89">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Material_4_notax_20']){ ?>
					<tr>
						<td><?php if(!$head_mat_4){ echo "Materiaalkosten"; $head_mat_4=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Material_4_notax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">6%</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Material_4_tax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Material_4_notax_10']){ ?>
					<tr>
						<td><?php if(!$head_mat_4){ echo "Materiaalkosten"; $head_mat_4=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Material_4_notax_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">0%</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php if($rs_project_result_row['Physical_4_notax_40']){ ?>
					<tr>
						<td><?php if(!$head_phys_4){ echo "Materieelkosten"; $head_phys_4=1; } ?></td>
						<td width="89">&nbsp;</td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="127" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Physical_4_notax_40'], 2, ',', '.'); ?></td>
						<td width="81">&nbsp;</td>
						<td width="117" align="center">21%</td>
						<td width="20">&nbsp;</td>
						<td class="tbl-subhead" width="126" align="right"><?php echo '&euro;'.number_format($rs_project_result_row['Physical_4_tax_40'], 2, ',', '.'); ?></td>
						<td width="89">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Physical_4_notax_20']){ ?>
					<tr>
						<td><?php if(!$head_phys_3){ echo "Materieelkosten"; $head_phys_3=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Physical_4_notax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">6%</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Physical_4_tax_20'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Physical_4_notax_10']){ ?>
					<tr>
						<td><?php if(!$head_phys_4){ echo "Materieelkosten"; $head_phys_4=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Physical_4_notax_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">0%</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php if($rs_project_result_row['Sum_4_notax_40']){ ?>
					<tr>
						<td><?php if(!$head_sum_4){ echo "Totaalposten"; $head_sum_4=1; } ?></td>
						<td width="89">&nbsp;</td>
						<td width="20">&nbsp;</td>
						<td width="127" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_4_notax_40'], 2, ',', '.'); ?></td>
						<td width="81">&nbsp;</td>
						<td width="117" align="center">21%</td>
						<td width="20">&nbsp;</td>
						<td width="126" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_4_tax_40'], 2, ',', '.'); ?></td>
						<td width="89">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Sum_4_notax_20']){ ?>
					<tr>
						<td><?php if(!$head_sum_4){ echo "Totaalposten"; $head_sum_4=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_4_notax_20'], 2, ',', '.'); ?></td>
						<td align="right">&nbsp;</td>
						<td align="center">6%</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_4_tax_20'], 2, ',', '.'); ?></td>
						<td align="right">&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($rs_project_result_row['Sum_4_notax_10']){ ?>
					<tr>
						<td><?php if(!$head_sum_4){ echo "Totaalposten"; $head_sum_4=1; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td width="127" align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($rs_project_result_row['Sum_4_notax_10'], 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
						<td align="center">0%</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php } ?>
					<tr>
						<td><b><i>Totaal Stelposten</i></b></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="center" class="tbl-head"><?php if($total_4_notax = $rs_project_result_row['Salary_4_notax_40']+$rs_project_result_row['Salary_4_notax_20']+$rs_project_result_row['Salary_4_notax_10']+$rs_project_result_row['Material_4_notax_40']+$rs_project_result_row['Material_4_notax_20']+$rs_project_result_row['Material_4_notax_10']+$rs_project_result_row['Physical_4_notax_40']+$rs_project_result_row['Physical_4_notax_20']+$rs_project_result_row['Physical_4_notax_10']+$rs_project_result_row['Sum_4_notax_40']+$rs_project_result_row['Sum_4_notax_20']+$rs_project_result_row['Sum_4_notax_10']){ echo '&euro;'.number_format($total_4_notax, 2, ',', '.'); }else{ echo "-"; } ?></td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td align="center" class="tbl-head"><?php if($total_4_tax = $rs_project_result_row['Salary_4_tax_40']+$rs_project_result_row['Salary_4_tax_20']+$rs_project_result_row['Material_4_tax_40']+$rs_project_result_row['Material_4_tax_20']+$rs_project_result_row['Physical_4_tax_40']+$rs_project_result_row['Physical_4_tax_20']+$rs_project_result_row['Sum_4_tax_40']+$rs_project_result_row['Sum_4_tax_20']){ echo '&euro;'.number_format($total_4_tax, 2, ',', '.'); }else{ echo "-"; } ?></td>
					</tr>
					<tr class="tbl-even">
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<tr>
						<td>Calculatief te offereren (excl. BTW)</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					<?php }} ?>
					<?php if($tax_total_7 = $rs_project_result_row['Salary_4_tax_40']+$rs_project_result_row['Material_4_tax_40']+$rs_project_result_row['Physical_4_tax_40']+$rs_project_result_row['Sum_4_tax_40']){ ?>
					<tr>
						...
						<td align="center">&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($tax_total_7, 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
					</tr>
					<?php } ?>
					<?php if($tax_total_8 = $rs_project_result_row['Salary_4_tax_20']+$rs_project_result_row['Material_4_tax_20']+$rs_project_result_row['Physical_4_tax_20']+$rs_project_result_row['Sum_4_tax_20']){ ?>
					<tr>
						...
						<td align="center">&nbsp;</td>
						<td>&nbsp;</td>
						<td align="right" class="tbl-subhead"><?php echo '&euro;'.number_format($tax_total_8, 2, ',', '.'); ?></td>
						<td>&nbsp;</td>
					</tr>
					<?php } ?>
					<tr>
