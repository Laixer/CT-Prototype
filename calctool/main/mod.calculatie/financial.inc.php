...
<div id="page-bgtop">
	...
	<div id="content-left">
		<div id="intern">
			...
			<div class="details">
				<div class="details-container">
					<input name="" type="button" id="btn_submit" style="width:180px; background: #FFF url('../images/add.png') no-repeat top left; padding-left: 20px; background-size: 16px; background-position-x: 2px; background-position-y: 2px;" onclick="document.location='?p_id=147&amp;r_id=<?php echo $rs_project_detail_row['Project_id']; ?>&amp;_utm=<?php echo $__url_session; ?>'" value="Winst / verlies berekening" />
				</div>
			</div>
			<?php } ?>
		</div>
