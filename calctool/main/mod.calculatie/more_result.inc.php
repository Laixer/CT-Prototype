...
# Object totals
$rs_project_result_qry = sprintf("SELECT * FROM tvw_result_more WHERE Project_id='%s' LIMIT 1", $rs_project_perm_check_row['Project_id']);
...
<div id="page-bgtop">
	<div id="title">
		...
		<span>Eindresultaat Meerwerk</span>
